...
class ODE_solver:
    ...
    def backward_euler(self, epsilon = 1e-06):
        ...
        >>> ode.backward_euler()
        ([1, 1.1, 1.2000000000000002, 1.3000000000000003, 1.4000000000000004, 1.5000000000000004, 1.6000000000000005, 1.7000000000000006, 1.8000000000000007, 1.9000000000000008, 2], [0.8, 1.02, 1.26, 1.52, 1.8, 2.1, 2.4200000000000004, 2.7600000000000007, 3.120000000000001, 3.5000000000000013, 3.9000000000000012])
        """
    ...
    def BDF(self, epsilon = 1e-06):
        ...
        >>> obj.BDF()
        ([1, 1.1, 1.2000000000000002, 1.3000000000000003, 1.4000000000000004, 1.5000000000000004, 1.6000000000000005, 1.7000000000000006, 1.8000000000000007, 1.9000000000000008, 2.000000000000001], [0.8, 1.0100028876739957, 1.2400029762488538, 1.4900030227013614, 1.7600030613655735, 2.0500030861821226, 2.3600031183809405, 2.6900031380352489, 3.040003145145048, 3.4100031693276773, 3.8000031911685168])
        """
